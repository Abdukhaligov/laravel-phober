              ...
              <div class="text-left">
                <form class="form" @submit.prevent>
                  <div id="username-field" class="field-wrapper input">
                    ...
                    <input id="login" v-model="login" name="login" type="text" class="form-control" placeholder="e.g mail@domain.com">
                  </div>
                  ...
                  <div class="d-sm-flex justify-content-between">
                    <div class="field-wrapper">
                      <button @click="authorization" type="submit" class="btn btn-primary" value="">Log In</button>
                    </div>
                  </div>
                </form>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      authorization() {
        this.setCredential([this.login, this.password]);
      }
    },
